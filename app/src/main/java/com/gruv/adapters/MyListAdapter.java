...
public class MyListAdapter extends ArrayAdapter<String> {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        TextView titleText = rowView.findViewById(R.id.textEventTitle);
        TextView textStartTime = rowView.findViewById(R.id.textEventStartTime);
        TextView textTagAlongers = rowView.findViewById(R.id.textEventTagAlongers);
        ImageView imgProfilePic = rowView.findViewById(R.id.imageViewProfilePic);
