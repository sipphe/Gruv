...
public class MessagesListAdapter extends ArrayAdapter<String> {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        TextView textSenderName = rowView.findViewById(R.id.textSendersName);
        TextView textMessagePreview = rowView.findViewById(R.id.textMessagePreview);
        TextView textMessageTime = rowView.findViewById(R.id.textMessageTime);
        ImageView imgProfilePic = rowView.findViewById(R.id.imageProfilePic);
